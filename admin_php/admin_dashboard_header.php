...
<header>
    <div class="header-container">
        ...
        <div class="button-group">
            <a href="admin_manage_donors.php" class="admin-login">MANAGE DONORS</a>
            <a href="admin_logout.php" class="admin-login">LOGOUT</a>
            <a href="admin_activity_report.php" class="admin-login">ACTIVITY</a>
